...
and clipped here; the file is hard-linked from stockholm-bus-map rather than
downloaded twice.
"""
...
S, N, W, E = 57.44, 58.0, 11.53, 12.63
RAIL_BOX = (57.6, 11.78, 57.85, 12.15)
...
rail_file = os.path.join(ROOT, 'data/osm/goteborg-rail.json')
